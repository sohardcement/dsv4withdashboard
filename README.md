...
The Huihui mirror publishes an alternative DSpark support GGUF
(`dspark-DeepSeek-V4-Flash-0731-Q8_0.gguf`, about 10.6 GiB, `dflash`
architecture with MXFP4 routed experts). DS4 cannot load it directly; repack
it into the support layout with `gguf-tools/deepseek4-quantize --dspark-gguf`
(see `gguf-tools/README.md`).
