...
"</main><script>"
"const $=id=>document.getElementById(id),dash=$('dashboard');let lastSnapshot=null,online=false,adminLocal=true,adminBusy=false,adminGeneration=0,pollGeneration=0,contextLocal=true,contextBusy=false,kvTargetTouched=false,contextTargetTouched=false;"
