...
static void test_dashboard_page_is_served_as_html(void) {
    ...
    TEST_ASSERT(strstr(out, "<h1 id=\"monitorTitle\" class=\"monitor-title\">实时运行</h1>") != NULL);
    TEST_ASSERT(strstr(out, "id=\"monitorCalls\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"requestInspector\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"monitorHost\"") != NULL);
