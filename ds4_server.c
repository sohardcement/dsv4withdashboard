...
":root{color-scheme:light;--surface:#f4f5f2;--surface-raised:#fff;--text:#141713;--text-muted:#626862;--rule:#bcc2bc;--signal:#145df5;--danger:#a52a1c;--control-height:44px;--instrument-font:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}"
"*{box-sizing:border-box}body{margin:0;background:var(--surface);color:var(--text);font:15px/1.5 Avenir,\"Gill Sans\",\"Trebuchet MS\",Arial,sans-serif}"
"button,input,select{min-height:var(--control-height);font:inherit;color:inherit;border:1px solid var(--text);background:var(--surface-raised);border-radius:0}button{padding:0 18px;cursor:pointer}button.primary{background:var(--text);color:var(--surface)}button:disabled{cursor:not-allowed;opacity:.45}button:focus-visible,input:focus-visible,select:focus-visible{outline:3px solid var(--signal);outline-offset:2px}input{width:9rem;padding:0 10px;font-family:var(--instrument-font)}select{padding:0 30px 0 10px}"
".page{max-width:1240px;margin:auto;padding:24px 32px 64px}.topbar{display:grid;grid-template-columns:auto auto 1fr;align-items:center;gap:24px;padding-bottom:18px;border-bottom:2px solid var(--text)}h1,h2,p{margin:0}.brand{font:800 24px/1 var(--instrument-font);letter-spacing:-.04em}.model{margin:14px 0 0;color:var(--text-muted)}.mode-switch{display:flex;gap:0}.mode-switch button[aria-pressed=true]{background:var(--text);color:var(--surface)}.state{display:flex;gap:18px;align-items:flex-end;justify-content:flex-end}.eyebrow{color:var(--text-muted);font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.state strong{display:block;margin-top:4px;font-family:var(--instrument-font);font-weight:500}.phase{color:var(--signal)}"
".hero{display:grid;grid-template-columns:2fr 1fr;border-bottom:1px solid var(--rule)}.hero>div{padding:42px 0 36px}.hero>div+div{border-left:1px solid var(--rule);padding-left:36px}.hero-value{font:400 clamp(62px,9vw,126px)/.88 Georgia,\"Times New Roman\",serif;letter-spacing:-.055em;margin:18px 0 16px}.secondary-value{font:400 clamp(42px,5vw,72px)/1 Georgia,\"Times New Roman\",serif;margin:22px 0 18px}.accent{color:var(--signal)}.caption{color:var(--text-muted)}.mono{font-family:var(--instrument-font);font-variant-numeric:tabular-nums}"
".strip{display:grid;grid-template-columns:repeat(4,1fr);border-bottom:1px solid var(--text)}.datum{min-width:0;padding:20px 20px 22px 0}.datum+.datum{border-left:1px solid var(--rule);padding-left:20px}.datum strong{display:block;margin-top:8px;font:400 20px/1.25 Georgia,\"Times New Roman\",serif}.datum small{display:block;color:var(--text-muted);margin-top:6px}.progress{height:3px;background:var(--rule);margin-top:13px;overflow:hidden}.progress span{display:block;height:100%;width:0;background:var(--signal);transition:width .2s linear}"
".section{padding:30px 0;border-bottom:1px solid var(--text)}.section-head{display:flex;justify-content:space-between;align-items:baseline;gap:20px;margin-bottom:20px}.section h2{font:400 27px/1.1 Georgia,\"Times New Roman\",serif}.process{display:grid;grid-template-columns:1fr 1fr 1fr;gap:28px}.big{font:400 44px/1 Georgia,\"Times New Roman\",serif;margin:10px 0}.capacity-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:44px}.capacity-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.capacity-stats strong{display:block;margin-top:7px;font-size:19px}.editor{border-left:1px solid var(--rule);padding-left:34px}.controls{display:flex;flex-wrap:wrap;gap:9px;margin-top:14px}.notice{min-height:24px;margin-top:14px;color:var(--text-muted)}.notice.bad{color:var(--danger)}"
"table{width:100%;border-collapse:collapse;font-size:13px}th,td{text-align:left;padding:10px 12px 10px 0;border-top:1px solid var(--rule);vertical-align:top}th{color:var(--text-muted);font-weight:500;width:16%}td{font-family:var(--instrument-font);overflow-wrap:anywhere}.stale .phase{color:var(--danger)}"
"@media(max-width:760px){.page{padding:16px 16px 44px}.topbar{grid-template-columns:1fr}.mode-switch button{flex:1}.state{justify-content:space-between;gap:8px}.hero{grid-template-columns:1fr}.hero>div{padding:32px 0}.hero>div+div{border-left:0;border-top:1px solid var(--rule);padding-left:0}.strip,.process,.capacity-grid,.capacity-stats{grid-template-columns:1fr}.datum+.datum{border-left:0;border-top:1px solid var(--rule);padding-left:0}.capacity-grid{gap:26px}.editor{border-left:0;border-top:1px solid var(--rule);padding:26px 0 0}.hero-value{font-size:72px}.controls>*{flex:1 1 auto}input{font-size:16px;width:min(11rem,60vw)}.section-head{display:block}.section-head .caption{margin-top:8px}}"
"@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important}}"
".dashboard-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:28px}.call-filters{display:flex;gap:8px;flex-wrap:wrap}.call-filters input,.call-filters select{min-width:0}.call-table-wrap{overflow-x:auto}.call-table-wrap table{min-width:640px}@media(max-width:760px){.dashboard-grid{grid-template-columns:1fr}}"
".mode-layout[hidden]{display:none!important}.monitor-layout{min-height:1px}.admin-dock{margin:30px 0;padding:22px;border:1px solid var(--text);display:grid;grid-template-columns:1fr 1fr;gap:28px}.admin-dock .editor{border-left:0;padding-left:0}@media(max-width:760px){.admin-dock{grid-template-columns:1fr;gap:22px}}"
".paper-conclusion{display:grid;grid-template-columns:1.4fr 1fr 1fr;gap:0;margin-top:28px;border-top:2px solid var(--text);border-bottom:1px solid var(--text)}.paper-conclusion>div{padding:22px 20px 22px 0}.paper-conclusion>div+div{padding-left:20px;border-left:1px solid var(--rule)}.paper-conclusion strong{display:block;margin-top:8px;font:400 30px/1.1 Georgia,serif;overflow-wrap:anywhere}.paper-conclusion .conclusion-health{color:var(--signal)}@media(max-width:760px){.paper-conclusion{grid-template-columns:1fr;margin-top:20px}.paper-conclusion>div+div{padding-left:0;border-left:0;border-top:1px solid var(--rule)}}"
"</style></head><body><main class=\"page\" id=\"dashboard\" data-mode=\"management\"><header class=\"topbar\"><h1 class=\"brand\">DS4</h1><div class=\"mode-switch\" role=\"group\" aria-label=\"仪表板模式\"><button type=\"button\" data-mode-choice=\"management\" aria-pressed=\"true\">管理模式</button><button type=\"button\" data-mode-choice=\"monitor\" aria-pressed=\"false\">监控模式</button></div><div class=\"state\"><div><span class=\"eyebrow\">连接</span><strong id=\"connectionState\" class=\"phase\">连接中</strong></div><div><span class=\"eyebrow\">健康</span><strong id=\"health\">等待中</strong></div><div><span class=\"eyebrow\">更新</span><strong id=\"updatedAt\">—</strong></div></div></header><p id=\"model\" class=\"model\">正在读取状态</p><div id=\"managementLayout\" class=\"mode-layout management-layout\" aria-hidden=\"false\"><section id=\"paperConclusion\" class=\"paper-conclusion\" aria-label=\"运行结论\"><div class=\"conclusion-health\"><span class=\"eyebrow\">当前运行结论</span><strong id=\"paperHealthConclusion\" data-bind=\"health\">等待中</strong><p id=\"phase\" class=\"caption\">连接中</p></div><div><span class=\"eyebrow\">上下文摘要</span><strong id=\"paperContextSummary\" data-bind=\"contextCurrent\">—</strong><p data-bind=\"contextRemaining\" class=\"caption\">—</p></div><div><span class=\"eyebrow\">KV 缓存摘要</span><strong id=\"paperCacheSummary\" data-bind=\"requestHitRate\">—</strong><p data-bind=\"kvUtilization\" class=\"caption\">—</p></div></section>"
...
"function chineseStatic(){$('currentTitle').textContent='当前请求 / KV token 命中';document.querySelectorAll('#managementLayout .hero .eyebrow').forEach((e,i)=>e.textContent=['当前请求 / KV token 命中','解码 / 平均'][i]);document.querySelectorAll('#managementLayout .hero .caption').forEach(e=>e.textContent='—');document.querySelectorAll('#managementLayout .strip .eyebrow').forEach((e,i)=>e.textContent=['预填充','解码进度','当前会话','请求'][i]);document.querySelectorAll('#managementLayout .process .eyebrow').forEach((e,i)=>e.textContent=['token 命中率','请求命中率','结果'][i]);document.querySelectorAll('#kvCapacity .capacity-stats .eyebrow').forEach((e,i)=>e.textContent=['已用','容量上限','条目 / 利用率'][i]);document.querySelectorAll('#managementLayout .section h2').forEach((e,i)=>e.textContent=['进程记录','磁盘 KV 容量','上下文窗口','主机资源','调用记录','请求详情'][i]);document.querySelectorAll('#managementLayout .section-head .caption').forEach((e,i)=>{if(i<4)e.textContent=['计数器会在此服务器进程重启时清零。','索引磁盘缓存；上方实时上下文以 token 计。','数值以 token 计，不代表 RAM。','系统采样不可用时明确标注。'][i]});$('kvForm').querySelector('label').textContent='容量上限';$('kvBudgetUnit').setAttribute('aria-label','容量单位');$('budgetHelp').textContent='最小 256 MB。立即应用会修改运行时状态；保存会写入下次启动上限。';$('kvApplyNow').textContent='立即应用';$('kvSaveRestart').textContent='保存供重启后使用';$('adminDock').append($('kvForm'),$('contextForm'))}chineseStatic();"
...
"function paint(s){lastSnapshot=s;online=true;dash.classList.remove('stale');const m=s.model||{},r=s.request||{},p=s.prefill||{},d=s.decode||{},t=s.totals||{},c=t.cache||{},k=s.kv_cache||{};text('connectionState','已连接');text('updatedAt',new Date().toLocaleTimeString('zh-CN',{hour12:false}));text('model',(m.name||'Unknown model')+' / '+(m.backend||'unknown backend')+' / '+num(m.context_length).toLocaleString()+' token context');text('phase',s.phase||'idle');text('health',s.active?'active':'ready');"
...
"async function tick(){const generation=++pollGeneration;try{const response=await fetch('/ds4/status',{cache:'no-store'});if(!response.ok)throw new Error('status '+response.status);const snapshot=await response.json();if(generation===pollGeneration)paint(snapshot)}catch(e){if(generation===pollGeneration){online=false;dash.classList.add('stale');text('connectionState','离线');text('health',lastSnapshot?'数据已过期':'不可用');controls((lastSnapshot&&lastSnapshot.kv_cache)||{});contextControls()}}finally{if(generation===pollGeneration)setTimeout(tick,1000)}}$('kvApplyNow').addEventListener('click',applyNow);$('kvSaveRestart').addEventListener('click',saveRestart);$('contextSaveRestart').addEventListener('click',saveContext);tick();"
"</script></body></html>\n";
