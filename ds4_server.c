...
".mode-layout[hidden]{display:none!important}.admin-dock{margin:30px 0;padding:22px;border:1px solid var(--ink);display:grid;grid-template-columns:1fr 1fr;gap:28px}.admin-dock .editor{border-left:0;padding-left:0}@media(max-width:760px){.admin-dock{grid-template-columns:1fr;gap:22px}}"
...
"</style></head><body><main class=\"page\" id=\"dashboard\" data-mode=\"management\"><header class=\"topbar\"><h1 class=\"brand\"><a href=\"#managementSummary\"><span class=\"status-glyph\" aria-hidden=\"true\">◆</span>DS4</a></h1><nav class=\"mode-switch\" aria-label=\"Dashboard 模式\"><button type=\"button\" data-mode-choice=\"management\" aria-pressed=\"true\">管理模式</button><button type=\"button\" data-mode-choice=\"monitor\" aria-pressed=\"false\">监控模式</button></nav><div id=\"connectionState\" class=\"state\"><span class=\"status-dot\" aria-hidden=\"true\"></span><strong id=\"health\" aria-label=\"健康\">等待中</strong><strong id=\"updatedAt\" aria-label=\"更新时间\">—</strong></div></header><p id=\"model\" class=\"model\">正在读取状态</p><div id=\"managementLayout\" class=\"mode-layout management-layout\" aria-hidden=\"false\"><section id=\"managementSummary\" class=\"paper-conclusion\" aria-label=\"运行结论\"><div class=\"conclusion-health\"><span class=\"eyebrow\">当前运行结论</span><strong id=\"paperHealthConclusion\" data-bind=\"health\">等待中</strong><p id=\"phase\" class=\"caption\">连接中</p></div><div><span class=\"eyebrow\">上下文摘要</span><strong id=\"paperContextSummary\" data-bind=\"contextCurrent\">—</strong><p data-bind=\"contextRemaining\" class=\"caption\">—</p></div><div><span class=\"eyebrow\">KV 缓存摘要</span><strong id=\"paperCacheSummary\" data-bind=\"requestHitRate\">—</strong><p data-bind=\"kvUtilization\" class=\"caption\">—</p></div></section>"
