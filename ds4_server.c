...
":root{color-scheme:light;--bg:#f7f9fb;--paper:#ffffff;--paper2:#f2f5f8;--ink:#111827;--muted:#64748b;--soft:#94a3b8;--line:#d9e1ea;--line2:#edf1f5;--accent:#2563eb;--accent2:#0f766e;--bad:#b91c1c;--shadow:0 18px 60px rgba(15,23,42,.07)}"
"*{box-sizing:border-box}body{margin:0;background:linear-gradient(180deg,#fbfcfd 0%,var(--bg) 42%,#f4f7fa 100%);color:var(--ink);font:14px/1.45 ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,\"Segoe UI\",sans-serif}"
".wrap{max-width:1180px;margin:0 auto;padding:32px 24px 40px}.top{display:grid;grid-template-columns:1fr auto;align-items:start;gap:18px;margin-bottom:22px;border-bottom:1px solid var(--line);padding-bottom:18px}.title h1{font-size:25px;line-height:1.05;margin:0 0 8px;font-weight:680;letter-spacing:0}.title p{margin:0;color:var(--muted);max-width:860px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}"
".pill{display:inline-flex;align-items:center;height:34px;padding:0 13px;border:1px solid var(--line);border-radius:6px;background:var(--paper);box-shadow:0 1px 0 rgba(15,23,42,.03);font-size:12px;font-weight:680;text-transform:uppercase;letter-spacing:.08em;color:var(--muted)}.pill.active{border-color:#9bbcff;color:var(--accent);background:#f5f8ff}"
".grid{display:grid;grid-template-columns:repeat(12,1fr);gap:14px}.card{background:rgba(255,255,255,.92);border:1px solid var(--line);border-radius:8px;padding:16px;min-width:0;box-shadow:var(--shadow)}.metric{min-height:142px;display:flex;flex-direction:column;justify-content:space-between}.span3{grid-column:span 3}.span4{grid-column:span 4}.span6{grid-column:span 6}.span8{grid-column:span 8}.span12{grid-column:span 12}"
".label{color:var(--muted);font-size:11px;text-transform:uppercase;letter-spacing:.11em;font-weight:720}.value{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:30px;line-height:1.05;font-weight:620;margin-top:14px;white-space:nowrap;color:#0f172a}.sub{color:var(--muted);margin-top:8px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.bar{height:7px;background:var(--paper2);border:1px solid var(--line2);border-radius:999px;overflow:hidden;margin-top:16px}.fill{height:100%;width:0;background:linear-gradient(90deg,var(--accent),var(--accent2))}"
".kv{display:grid;grid-template-columns:minmax(112px,150px) minmax(0,1fr);gap:0;border-top:1px solid var(--line2);margin-top:12px}.kv div{min-height:32px;padding:8px 0;border-bottom:1px solid var(--line2);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.kv div:nth-child(odd){color:var(--muted);padding-right:12px}.mono{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;color:#0f172a}.small{font-size:13px}.bad{color:var(--bad)}.warn{color:#a16207}"
"@media(max-width:820px){.wrap{padding:20px 14px 28px}.top{display:block}.title p{white-space:normal}.pill{margin-top:14px}.span3,.span4,.span6,.span8{grid-column:span 12}.value{font-size:25px}.kv{grid-template-columns:1fr}.kv div:nth-child(odd){border-bottom:0;padding-bottom:0}.kv div:nth-child(even){padding-top:2px}}"
...
"<section class=\"grid\"><div class=\"card metric span3\"><div><div class=\"label\">Prefill</div><div id=\"prefillSpeed\" class=\"value\">0.0 t/s</div><div id=\"prefillSub\" class=\"sub\">0 / 0 tokens</div></div><div class=\"bar\"><div id=\"prefillBar\" class=\"fill\"></div></div></div>"
"<div class=\"card metric span3\"><div><div class=\"label\">Prefill ETA</div><div id=\"eta\" class=\"value\">0.0s</div><div id=\"prefillElapsed\" class=\"sub\">elapsed 0.0s</div></div></div>"
"<div class=\"card metric span3\"><div><div class=\"label\">Decode</div><div id=\"decodeSpeed\" class=\"value\">0.0 t/s</div><div id=\"decodeSub\" class=\"sub\">0 / 0 tokens</div></div></div>"
"<div class=\"card metric span3\"><div><div class=\"label\">Queue</div><div id=\"queue\" class=\"value\">0</div><div id=\"clients\" class=\"sub\">0 clients</div></div></div>"
