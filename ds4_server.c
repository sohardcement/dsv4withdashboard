...
"@media(max-width:760px){.page{padding:16px 16px 44px}.topbar{grid-template-columns:1fr}.mode-switch button{flex:1}.state{justify-content:flex-start;gap:12px}.management-grid{grid-template-columns:1fr;gap:0;margin-top:20px}.management-nav{display:none}.summary-ruler,.settings-grid,.capacity-stats,.host-ruler{grid-template-columns:1fr}.summary-cell+.summary-cell,.host-ruler>div+div{padding-left:0;border-left:0;border-top:1px solid var(--line)}.settings-grid{gap:28px}.controls>*{flex:1 1 auto}input{font-size:16px;width:min(11rem,60vw)}.section-head,.setting-head{display:block}.section-head .caption,.effect{display:block;margin-top:8px}.recent-call{grid-template-columns:70px minmax(0,1fr);gap:6px 12px}.recent-call span:nth-child(3),.recent-call span:nth-child(4){color:var(--muted)}}"
