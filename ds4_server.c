...
":root{color-scheme:light;--paper:#f3f0e7;--surface:#f8f5ed;--ink:#171a1d;--muted:#706d65;--line:#c4bfb4;--accent:#df4932;--success:#28734b;--danger:#a52a1c;--control-height:44px;--instrument-font:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}"
"*{box-sizing:border-box}:focus-visible{outline:3px solid #2563eb;outline-offset:3px}body{margin:0;background:var(--paper);color:var(--ink);font:15px/1.5 Avenir,\"Gill Sans\",\"Trebuchet MS\",Arial,sans-serif}"
"button,input,select{min-height:var(--control-height);font:inherit;color:inherit;border:1px solid var(--ink);background:var(--surface);border-radius:0}button{padding:0 18px;cursor:pointer}button.primary{background:var(--ink);color:var(--surface)}button:disabled{cursor:not-allowed;opacity:.45}input{width:9rem;padding:0 10px;font-family:var(--instrument-font)}select{padding:0 30px 0 10px}"
".page{max-width:1240px;margin:auto;padding:24px 32px 64px}.topbar{display:grid;grid-template-columns:auto auto 1fr;align-items:center;gap:24px;padding-bottom:18px;border-bottom:2px solid var(--ink)}h1,h2,h3,p{margin:0}.brand{font:800 24px/1 var(--instrument-font);letter-spacing:-.04em}.brand a{display:inline-flex;align-items:center;gap:9px;color:inherit;text-decoration:none}.status-glyph{color:var(--accent);font-size:14px}.model{margin-top:8px;color:var(--muted)}.mode-switch{display:flex;gap:0}.mode-switch button[aria-pressed=true]{background:var(--ink);color:var(--surface)}.state{display:flex;gap:18px;align-items:center;justify-content:flex-end}.status-dot{width:9px;height:9px;border-radius:50%;background:var(--success)}.eyebrow{color:var(--muted);font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.state strong{font-family:var(--instrument-font);font-weight:500}.caption{color:var(--muted)}.mono{font-family:var(--instrument-font);font-variant-numeric:tabular-nums}"
".management-grid{display:grid;grid-template-columns:180px minmax(0,1fr);gap:40px;margin-top:28px}.management-nav{border-right:1px solid var(--line);padding-right:22px}.management-nav nav{position:sticky;top:24px;display:grid;gap:2px}.management-nav a{min-height:44px;display:flex;align-items:center;border-top:1px solid var(--line);color:var(--muted);text-decoration:none}.management-nav a:first-child{border-top:2px solid var(--ink);color:var(--ink)}.management-main{min-width:0}.management-summary{padding-bottom:30px;border-bottom:2px solid var(--ink)}.management-summary h1{font:400 clamp(42px,6vw,72px)/.95 Georgia,\"Times New Roman\",serif;letter-spacing:-.04em}.summary-ruler{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin-top:28px;border-top:1px solid var(--ink);border-bottom:1px solid var(--ink)}.summary-cell{min-width:0;padding:18px 18px 20px 0}.summary-cell+.summary-cell{padding-left:18px;border-left:1px solid var(--line)}.summary-cell strong{display:block;margin:8px 0 5px;font:400 clamp(22px,3vw,34px)/1.05 Georgia,serif;overflow-wrap:anywhere}.summary-cell:first-child strong{color:var(--accent)}"
...
".management-section{padding:30px 0;border-bottom:1px solid var(--ink)}.section-head{display:flex;justify-content:space-between;align-items:baseline;gap:20px;margin-bottom:20px}.recent-calls{table-layout:fixed}.recent-calls th,.recent-calls td{width:25%}.host-ruler{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));border-top:1px solid var(--line)}.host-ruler>div{padding:16px 16px 0 0}.host-ruler>div+div{padding-left:16px;border-left:1px solid var(--line)}.host-ruler strong{display:block;margin-top:7px;overflow-wrap:anywhere}"
"table{width:100%;border-collapse:collapse;font-size:13px}th,td{text-align:left;padding:10px 12px 10px 0;border-top:1px solid var(--line);vertical-align:top}th{color:var(--muted);font-weight:500;width:16%}td{font-family:var(--instrument-font);overflow-wrap:anywhere}.stale #managementPhase{color:var(--danger)}.stale .status-dot{background:var(--danger)}"
".monitor-layout{padding-top:28px}.monitor-title{font:400 clamp(38px,5vw,64px)/1 Georgia,\"Times New Roman\",serif;letter-spacing:-.035em}.monitor-metrics{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));margin:24px 0 30px;border-block:1px solid var(--ink)}.monitor-metrics>div{min-width:0;padding:16px}.monitor-metrics>div:first-child{padding-left:0}.monitor-metrics>div+div{border-left:1px solid var(--line)}.monitor-metrics strong{display:block;margin-top:7px;font:400 clamp(18px,2vw,27px)/1.1 Georgia,serif;overflow-wrap:anywhere}.monitor-grid{display:grid;grid-template-columns:minmax(0,1.55fr) minmax(260px,.65fr);gap:32px;align-items:start}.monitor-panel{min-width:0;border-top:2px solid var(--ink);padding-top:15px}.call-filters{display:grid;grid-template-columns:minmax(110px,1fr) repeat(3,minmax(0,.72fr));gap:8px;margin-bottom:14px}.call-filters input,.call-filters select{min-width:0;width:100%}.monitor-table-wrap{max-height:390px;overflow:auto;border-bottom:1px solid var(--ink)}.monitor-table{min-width:780px}.monitor-table tr[aria-selected=true]{background:#e7dfcf}.request-select{width:100%;min-height:44px;padding:0 8px;text-align:left;border-color:transparent;background:transparent;font-family:var(--instrument-font)}.request-select:hover{border-color:var(--ink)}.inspector{min-height:250px}.inspector dl{display:grid;grid-template-columns:minmax(92px,auto) minmax(0,1fr);margin:15px 0 0}.inspector dt,.inspector dd{margin:0;padding:8px 0;border-top:1px solid var(--line)}.inspector dt{color:var(--muted);padding-right:14px}.inspector dd{font-family:var(--instrument-font);overflow-wrap:anywhere}.monitor-host{grid-column:1/-1;margin-top:2px;padding-top:20px;border-top:1px solid var(--ink)}"
"@media(max-width:980px){.monitor-grid{grid-template-columns:1fr}.monitor-host{grid-column:auto}.monitor-table-wrap{max-height:330px}.monitor-metrics{grid-template-columns:repeat(3,minmax(0,1fr))}.monitor-metrics>div:nth-child(4){border-left:0}.monitor-metrics>div:nth-child(n+4){border-top:1px solid var(--line)}}@media(max-width:900px){.management-grid{grid-template-columns:1fr;gap:0;margin-top:20px}.management-nav{display:none}}"
"@media(max-width:760px){.page{padding:16px 16px 44px}.topbar{grid-template-columns:1fr}.mode-switch button{flex:1}.state{justify-content:flex-start;gap:12px}.summary-ruler,.settings-grid,.capacity-stats,.host-ruler{grid-template-columns:1fr}.summary-cell+.summary-cell,.host-ruler>div+div{padding-left:0;border-left:0;border-top:1px solid var(--line)}.settings-grid{gap:28px}.monitor-metrics{grid-template-columns:repeat(2,minmax(0,1fr))}.monitor-metrics>div:nth-child(odd){border-left:0}.monitor-metrics>div:nth-child(n+3){border-top:1px solid var(--line)}.call-filters{grid-template-columns:repeat(2,minmax(0,1fr))}.controls>*{flex:1 1 auto}input{font-size:16px;width:min(11rem,60vw)}.section-head,.setting-head{display:block}.section-head .caption,.effect{display:block;margin-top:8px}}"
"@media(max-width:420px){.page{padding-inline:12px}.monitor-metrics,.call-filters{grid-template-columns:1fr}.monitor-metrics>div{padding:13px 0;border-left:0!important;border-top:1px solid var(--line)}.monitor-metrics>div:first-child{border-top:0}.monitor-table-wrap{max-width:100%}}"
"@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important}}"
".mode-layout[hidden]{display:none!important}"
"</style></head><body><main class=\"page\" id=\"dashboard\" data-mode=\"management\"><header class=\"topbar\"><div class=\"brand\"><a href=\"#managementSummary\"><span class=\"status-glyph\" aria-hidden=\"true\">◆</span>DS4</a></div><nav class=\"mode-switch\" aria-label=\"Dashboard 模式\"><button type=\"button\" data-mode-choice=\"management\" aria-pressed=\"true\">管理模式</button><button type=\"button\" data-mode-choice=\"monitor\" aria-pressed=\"false\">监控模式</button></nav><div id=\"connectionState\" class=\"state\"><span class=\"status-dot\" aria-hidden=\"true\"></span><strong id=\"health\" aria-label=\"健康\">等待中</strong><strong id=\"updatedAt\" aria-label=\"更新时间\">—</strong></div></header><div id=\"managementLayout\" class=\"mode-layout management-layout\" aria-hidden=\"false\"><div class=\"management-grid\"><aside class=\"management-nav\"><nav aria-label=\"管理章节\"><a href=\"#managementSummary\">运行概览</a><a href=\"#kvCapacity\">KV 容量</a><a href=\"#contextCapacity\">上下文窗口</a><a href=\"#managementRecent\">最近调用</a><a href=\"#managementHost\">主机资源</a></nav></aside><div class=\"management-main\">"
"<section id=\"managementSummary\" class=\"management-summary\" aria-labelledby=\"managementTitle\"><h1 id=\"managementTitle\">运行与容量</h1><p id=\"model\" class=\"model\">正在读取状态</p><div class=\"summary-ruler\"><div class=\"summary-cell\"><span class=\"eyebrow\">运行阶段</span><strong id=\"managementPhase\">连接中</strong><p id=\"managementQueue\" class=\"caption mono\">—</p></div><div class=\"summary-cell\"><span class=\"eyebrow\">上下文余量</span><strong id=\"managementContext\">—</strong><p id=\"managementContextRatio\" class=\"caption mono\">—</p></div><div class=\"summary-cell\"><span class=\"eyebrow\">KV 已用 / 上限</span><strong id=\"managementKv\">—</strong><p id=\"managementKvRatio\" class=\"caption mono\">—</p></div></div></section>"
"<div class=\"settings-grid\"><section id=\"kvCapacity\" class=\"setting-block\" tabindex=\"-1\"><div class=\"setting-head\"><h2>磁盘 KV 容量</h2><span id=\"kvEffect\" class=\"effect\">立即影响运行</span></div><div class=\"capacity-stats\"><div><span class=\"eyebrow\">已用</span><strong id=\"kvUsed\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">容量上限</span><strong id=\"kvBudget\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">条目 / 利用率</span><strong id=\"kvEntries\" class=\"mono\">—</strong><small id=\"kvUtilization\" class=\"caption\">—</small></div></div><div class=\"progress\" aria-hidden=\"true\"><span id=\"kvBar\"></span></div><form class=\"editor\" id=\"kvForm\"><label class=\"eyebrow\" for=\"kvBudgetInput\">容量上限</label><div class=\"controls\"><input id=\"kvBudgetInput\" inputmode=\"decimal\" type=\"number\" min=\"0.25\" step=\"0.25\" aria-describedby=\"budgetHelp\"><select id=\"kvBudgetUnit\" aria-label=\"容量单位\"><option value=\"GB\">GB</option><option value=\"MB\">MB</option></select></div><p id=\"budgetHelp\" class=\"caption\">最小 256 MB。立即应用会修改运行时状态；保存会写入下次启动上限。</p><div class=\"controls\"><button id=\"kvApplyNow\" class=\"primary\" type=\"button\">立即应用</button><button id=\"kvSaveRestart\" type=\"button\">保存供重启后使用</button></div><section id=\"kvReview\" class=\"impact-review\" hidden tabindex=\"-1\" aria-labelledby=\"kvReviewTitle\"><h3 id=\"kvReviewTitle\">审阅运行时影响</h3><dl id=\"kvReviewFacts\"></dl><div class=\"controls\"><button id=\"kvConfirmApply\" class=\"primary\" type=\"button\">确认立即应用</button><button id=\"kvCancelApply\" type=\"button\">取消</button></div></section><div id=\"adminNotice\" class=\"notice\" role=\"status\" aria-live=\"polite\"></div></form></section>"
"<section id=\"contextCapacity\" class=\"setting-block\"><div class=\"setting-head\"><h2>上下文窗口</h2><span id=\"contextEffect\" class=\"effect\">重启后生效</span></div><div class=\"capacity-stats\"><div><span class=\"eyebrow\">当前 / 上限</span><strong id=\"contextCurrent\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">剩余</span><strong id=\"contextRemaining\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">利用率</span><strong id=\"contextUtilization\" class=\"mono\">—</strong></div></div><form class=\"editor\" id=\"contextForm\"><label class=\"eyebrow\" for=\"contextNextInput\">下次启动窗口（token）</label><div class=\"controls\"><input id=\"contextNextInput\" type=\"number\" inputmode=\"numeric\" min=\"4096\" step=\"1\"><button id=\"contextSaveRestart\" class=\"primary\" type=\"button\">保存下次启动设置</button></div><div id=\"contextNotice\" class=\"notice\" role=\"status\" aria-live=\"polite\"></div></form></section></div>"
"<section id=\"managementRecent\" class=\"management-section\"><div class=\"section-head\"><h2>最近调用</h2><p id=\"managementCallsActive\" class=\"caption\">当前活动请求：—</p></div><table class=\"recent-calls\"><thead><tr><th>请求</th><th>服务</th><th>API</th><th>结果</th></tr></thead><tbody id=\"managementRecentCalls\"></tbody></table></section>"
...
"<section id=\"monitorLayout\" class=\"mode-layout monitor-layout\" hidden aria-hidden=\"true\" aria-labelledby=\"monitorTitle\"><h2 id=\"monitorTitle\" class=\"monitor-title\">请求监控</h2><p class=\"model\">实时吞吐与最近调用检查器</p><div id=\"monitorMetrics\" class=\"monitor-metrics\"><div><span class=\"eyebrow\">阶段 / 服务</span><strong id=\"monitorPhase\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">预填充</span><strong id=\"monitorPrefill\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">解码 / 进度</span><strong id=\"monitorDecode\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">请求 KV 命中</span><strong id=\"monitorCacheHit\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">上下文利用率</span><strong id=\"monitorContext\" class=\"mono\">—</strong></div><div><span class=\"eyebrow\">队列 / 客户端</span><strong id=\"monitorQueue\" class=\"mono\">—</strong></div></div><div class=\"monitor-grid\"><section class=\"monitor-panel\" aria-labelledby=\"monitorCallsTitle\"><div class=\"section-head\"><h2 id=\"monitorCallsTitle\">最近调用</h2><p id=\"monitorCallsActive\" class=\"caption\">当前活动请求：—</p></div><div class=\"call-filters\"><input id=\"callFilterCaller\" data-call-filter=\"caller\" aria-label=\"按调用方筛选\" placeholder=\"调用方\"><select id=\"callFilterClient\" data-call-filter=\"client\" aria-label=\"按服务筛选\"><option value=\"\">全部服务</option></select><select id=\"callFilterApi\" data-call-filter=\"api\" aria-label=\"按 API 筛选\"><option value=\"\">全部 API</option></select><select id=\"callFilterStatus\" data-call-filter=\"result\" aria-label=\"按结果筛选\"><option value=\"\">全部结果</option><option value=\"active\">进行中</option><option value=\"completed\">完成</option><option value=\"failed\">失败</option></select></div><div class=\"monitor-table-wrap\"><table class=\"monitor-table\"><thead><tr><th>请求</th><th>服务</th><th>调用方</th><th>API</th><th>结果</th><th>时长</th><th>错误</th></tr></thead><tbody id=\"monitorCalls\"></tbody></table></div></section><aside id=\"requestInspector\" class=\"monitor-panel inspector\" tabindex=\"-1\" aria-labelledby=\"requestInspectorTitle\"><h2 id=\"requestInspectorTitle\">请求检查器</h2><p class=\"caption\">请选择一条调用记录</p></aside><section class=\"monitor-host\" aria-labelledby=\"monitorHostTitle\"><div class=\"section-head\"><h2 id=\"monitorHostTitle\">主机资源</h2><p class=\"caption\">系统采样不可用时明确标注。</p></div><div class=\"host-ruler\"><div><span class=\"eyebrow\">内存压力 / Swap</span><strong id=\"monitorHostPressure\" class=\"mono\">不可用</strong></div><div><span class=\"eyebrow\">物理内存 已用 / 总量 / 可用</span><strong id=\"monitorHostPhysical\" class=\"mono\">不可用</strong></div><div><span class=\"eyebrow\">DS4 RSS</span><strong id=\"monitorHostRss\" class=\"mono\">不可用</strong></div></div></section></div></section>"
"</main><script>"
"const $=id=>document.getElementById(id),dash=$('dashboard');let lastSnapshot=null,online=false,adminLocal=true,kvEnabled=false,kvState='idle',kvReview=null,kvTrigger=null,pollGeneration=0,contextLocal=true,contextBusy=false,kvTargetTouched=false,contextTargetTouched=false,selectedRequestId=null;"
"const finite=n=>n!==null&&n!==''&&Number.isFinite(Number(n)),num=n=>finite(n)?Number(n):0,ratio=(n,d)=>num(d)>0?num(n)/num(d):null,pct=v=>v==null?'—':(v*100).toFixed(1)+'%';"
...
"function replaceOptions(id,values,label){const select=$(id),old=select.value;select.replaceChildren();for(const value of [''].concat(values)){const option=document.createElement('option');option.value=value;option.textContent=value||label;select.append(option)}select.value=values.includes(old)?old:''}"
...
"function requestDuration(record,request,activeId){const started=finite(record.started_at)?Number(record.started_at):null,finished=finite(record.finished_at)?Number(record.finished_at):null;if(started!==null&&finished!==null&&finished>0)return finished>=started?(finished-started).toFixed(1)+'s':'—';if(record.status==='active'&&String(record.request_id)===String(activeId)){if(finite(request&&request.elapsed_sec)&&Number(request.elapsed_sec)>=0)return Number(request.elapsed_sec).toFixed(1)+'s';const now=Date.now()/1000;if(started!==null&&started<=now)return (now-started).toFixed(1)+'s'}return '—'}"
"function paintRequestInspector(record,request,activeId){const root=$('requestInspector');root.replaceChildren();const title=document.createElement('h2');title.id='requestInspectorTitle';title.textContent='请求检查器';root.append(title);if(!record){const empty=document.createElement('p');empty.className='caption';empty.textContent='请选择一条调用记录';root.append(empty);return}const facts=document.createElement('dl'),cache=pct(ratio(record.cached_tokens,record.prompt_tokens)),values=[['请求',record.request_id],['服务',record.client],['调用方',record.caller],['API',record.api],['类型',record.kind],['结果',callStatus(record.status)],['流式',record.stream?'是':'否'],['工具',record.tools?'是':'否'],['持续时间',requestDuration(record,request,activeId)],['提示 token',num(record.prompt_tokens).toLocaleString()],['缓存 token',num(record.cached_tokens).toLocaleString()+' / '+cache],['写入缓存 token',num(record.cache_write_tokens).toLocaleString()],['输出 token',num(record.output_tokens).toLocaleString()],['缓存来源',record.cache_source],['结束原因',record.finish],['错误',record.error]];for(const pair of values)inspectorFact(facts,pair[0],pair[1]);root.append(facts)}"
"function selectRequest(id){selectedRequestId=String(id);paintCalls((lastSnapshot||{}).calls,(lastSnapshot||{}).request)}"
"function paintCalls(calls,request){calls=calls||{};const records=(calls.records||[]).slice(0,200),activeId=calls.active_request_id;replaceOptions('callFilterClient',[...new Set(records.map(x=>x.client||''))].filter(Boolean),'全部服务');replaceOptions('callFilterApi',[...new Set(records.map(x=>x.api||''))].filter(Boolean),'全部 API');const caller=$('callFilterCaller').value.toLowerCase(),client=$('callFilterClient').value,api=$('callFilterApi').value,status=$('callFilterStatus').value,shown=records.filter(x=>(!caller||String(x.caller||'').toLowerCase().includes(caller))&&(!client||x.client===client)&&(!api||x.api===api)&&(!status||x.status===status)),focused=document.activeElement&&document.activeElement.classList.contains('request-select')?document.activeElement.closest('tr').dataset.requestId:null;if(!shown.some(x=>String(x.request_id)===selectedRequestId))selectedRequestId=null;const body=$('monitorCalls');body.replaceChildren();if(!shown.length){const row=document.createElement('tr'),cell=document.createElement('td');cell.colSpan=7;cell.textContent='暂无匹配调用';row.append(cell);body.append(row)}else for(const call of shown){const row=document.createElement('tr'),id=String(call.request_id||'');row.dataset.requestId=id;row.setAttribute('aria-selected',String(id===selectedRequestId));const first=document.createElement('td'),button=document.createElement('button');button.type='button';button.className='request-select';button.textContent=id||'—';button.setAttribute('aria-label','检查请求 '+(id||'未知'));button.addEventListener('click',()=>selectRequest(id));first.append(button);row.append(first);for(const value of [call.client,call.caller,call.api,callStatus(call.status),requestDuration(call,request,activeId),call.error]){const cell=document.createElement('td');cell.textContent=value==null||value===''?'—':String(value);row.append(cell)}body.append(row)}if(focused){const next=[...body.querySelectorAll('.request-select')].find(button=>button.closest('tr').dataset.requestId===focused);if(next)next.focus()}paintRequestInspector(records.find(x=>String(x.request_id)===selectedRequestId)||null,request,activeId);const active='当前活动请求：'+(activeId||'—');text('managementCallsActive',active);text('monitorCallsActive',active)}"
"function phaseLabel(value){return ({decode:'解码',prefill:'预填充',idle:'空闲'})[value]||'未知'}"
"function paintRecentCalls(calls){const root=$('managementRecentCalls'),records=((calls&&calls.records)||[]).slice(0,3);root.replaceChildren();if(!records.length){const row=document.createElement('tr'),cell=document.createElement('td');cell.colSpan=4;cell.textContent='暂无调用记录';row.append(cell);root.append(row);return}for(const call of records){const row=document.createElement('tr');row.dataset.callId=String(call.request_id||'');for(const value of [call.request_id,call.client,call.api,callStatus(call.status)]){const cell=document.createElement('td');cell.textContent=value==null||value===''?'—':String(value);row.append(cell)}root.append(row)}}"
"function pressure(v){return v==='normal'?'正常':v==='warning'?'警告':v==='critical'?'严重':'不可用'}"
"function paintHost(h){let physical='不可用',swap='不可用',rss='不可用';if(h&&h.available){const physicalValues=[h.memory_used_bytes,h.memory_total_bytes,h.memory_available_bytes],swapValues=[h.swap_used_bytes,h.swap_total_bytes];if(physicalValues.every(v=>Number.isFinite(Number(v))))physical=physicalValues.map(bytes).join(' / ');if(pressure(h.memory_pressure)!=='不可用'&&swapValues.every(v=>Number.isFinite(Number(v))))swap=pressure(h.memory_pressure)+' / '+swapValues.map(bytes).join(' / ');if(Number.isFinite(Number(h.process_rss_bytes)))rss=bytes(h.process_rss_bytes)}for(const prefix of ['management','monitor']){text(prefix+'HostPhysical',physical);text(prefix+'HostPressure',swap);text(prefix+'HostRss',rss)}}"
...
"function paintMonitor(s){const p=s.prefill||{},d=s.decode||{},r=s.request||{},x=s.context||{},calls=s.calls||{},active=(calls.records||[]).find(call=>String(call.request_id)===String(calls.active_request_id));text('monitorPhase',phaseLabel(s.phase)+' / '+(active&&active.client||'—'));text('monitorPrefill',finite(p.avg_tps)?Number(p.avg_tps).toFixed(1)+' t/s · '+num(p.current).toLocaleString()+' / '+num(p.total).toLocaleString():'不可用');text('monitorDecode',finite(d.avg_tps)?Number(d.avg_tps).toFixed(1)+' t/s · '+num(d.generated).toLocaleString()+' / '+num(d.max_tokens).toLocaleString():'不可用');text('monitorCacheHit',ratio(r.cached_tokens,r.prompt_tokens)==null?'不可用':pct(ratio(r.cached_tokens,r.prompt_tokens)));text('monitorContext',finite(x.utilization)?pct(Number(x.utilization)):'不可用');text('monitorQueue',finite(s.queue_depth)&&finite(s.clients)?num(s.queue_depth).toLocaleString()+' / '+num(s.clients).toLocaleString():'不可用');paintCalls(calls,r)}"
"function paint(s){lastSnapshot=s;online=true;dash.classList.remove('stale');const m=s.model||{},k=s.kv_cache||{},x=s.context||{};kvEnabled=k.enabled===true;text('updatedAt',new Date().toLocaleTimeString('zh-CN',{hour12:false}));text('model',(m.name||'未知模型')+' / '+(m.backend||'未知后端')+' / '+num(m.context_length).toLocaleString()+' token 上下文');text('health',s.active?'运行中':'就绪');paintManagement(s);paintMonitor(s);"
"if(!k.enabled){text('kvUsed','已禁用');text('kvBudget','已禁用');text('kvEntries','—');text('kvUtilization','未配置磁盘 KV 缓存。');$('kvBar').style.width='0%'}else{const ku=ratio(k.used_bytes,k.budget_bytes);text('kvUsed',bytes(k.used_bytes));text('kvBudget',bytes(k.budget_bytes));text('kvEntries',num(k.entries).toLocaleString());text('kvUtilization',pct(ku)+' 已使用');$('kvBar').style.width=Math.max(0,Math.min(100,(ku||0)*100))+'%';if(!kvTargetTouched&&!$('kvForm').contains(document.activeElement)){$('kvBudgetInput').value=(num(k.budget_bytes)/1073741824).toFixed(2).replace(/\\.?0+$/,'');$('kvBudgetUnit').value='GB'}}text('contextCurrent',num(x.current_tokens).toLocaleString()+' / '+num(x.limit_tokens).toLocaleString());text('contextRemaining',num(x.remaining).toLocaleString());text('contextUtilization',pct(x.utilization));if(!contextTargetTouched&&!$('contextForm').contains(document.activeElement))$('contextNextInput').value=num(x.next_limit_tokens)||num(x.limit_tokens)||'';contextControls();setKvState(kvState)}"
...
"function finishKvSuccess(message){kvReview=null;setKvState('success');setKvMessage(message,false);focusKvTrigger()}"
...
"function normalizeRuntime(body,requireApplied){const r=body&&body.runtime,invalid=()=>{throw kvLocalError('操作失败：服务器返回的运行时结果无法读取。','unreadable_runtime')};if(!r||typeof r!=='object'||Array.isArray(r)||r.attempted!==true||r.ok!==true||r.applied!==requireApplied||typeof r.eviction_required!=='boolean'||typeof r.revision!=='string'||!/^(0|[1-9][0-9]*)$/.test(r.revision))invalid();const normalized={ok:true,applied:r.applied,revision:r.revision,eviction_required:r.eviction_required};for(const field of ['old_budget_bytes','new_budget_bytes','before_bytes','after_bytes','before_entries','after_entries']){if(typeof r[field]!=='number'||!Number.isSafeInteger(r[field])||r[field]<0)invalid();normalized[field]=r[field]}if(normalized.after_bytes>normalized.before_bytes||normalized.after_entries>normalized.before_entries)invalid();return normalized}"
"async function checkKvImpact(){if(['checking','review','applying','saving'].includes(kvState))return;kvTrigger=$('kvApplyNow');let mb;try{mb=budgetMB()}catch(e){finishKvError(e);return}setKvState('checking');setKvMessage('正在检查清理压力…',false);try{showKvReview(normalizeRuntime(await admin('dry-run',mb),false),mb)}catch(e){finishKvError(e)}}"
"async function confirmKvApply(){if(kvState!=='review'||!kvReview||!online||!adminLocal||!kvEnabled){setKvState(kvState);return}const reviewed=kvReview;setKvState('applying');setKvMessage('正在应用已审阅的运行时上限…',false);try{let applied;try{applied=normalizeRuntime(await admin('apply',reviewed.mb,String(reviewed.runtime.revision)),true)}catch(e){if(e.code!=='kv_state_changed')throw e;setKvMessage('KV 状态已变化，正在重新检查影响…',false);const refreshed=normalizeRuntime(await admin('dry-run',reviewed.mb),false),fingerprint=reviewFingerprint(refreshed);if(fingerprint!==reviewed.fingerprint){showKvReview(refreshed,reviewed.mb);return}try{applied=normalizeRuntime(await admin('apply',reviewed.mb,String(refreshed.revision)),true)}catch(retry){if(retry.code==='kv_state_changed')throw kvLocalError('KV 状态持续变化，请等待活动缓存操作结束后重试。','kv_state_changed');throw retry}}finishKvSuccess(runtimeMessage(applied))}catch(e){finishKvError(e)}}"
...
"async function persistKvBudget(){if(['checking','review','applying','saving'].includes(kvState))return;kvTrigger=$('kvSaveRestart');let mb;try{mb=budgetMB()}catch(e){finishKvError(e);return}setKvState('saving');setKvMessage('正在保存下次启动上限…',false);try{const saved=await admin('persist',mb),p=saved.persistent||{};if(!p.committed)throw kvLocalError('服务器未提交下次启动设置。');if(!p.ok||!p.durable){kvReview=null;setKvState('error');setKvMessage(persistentMessage(saved),true);focusKvTrigger();return}finishKvSuccess(persistentMessage(saved))}catch(e){finishKvError(e)}}"
"function contextNotice(message,bad){$('contextNotice').className=bad?'notice bad':'notice';text('contextNotice',message)}async function saveContext(){if(contextBusy)return;const value=Number($('contextNextInput').value);if(!Number.isInteger(value)||value<4096||value>2147483647){contextNotice('请输入 4,096 到 2,147,483,647 之间的整数 token 上限。',true);return}contextBusy=true;contextNotice('正在保存下次启动设置…',false);contextControls();try{const response=await fetch('/ds4/admin/context',{method:'POST',headers:{'Content-Type':'application/json','X-DS4-Admin':'1'},body:JSON.stringify({context_tokens:value})});let body;try{body=await response.json()}catch(e){throw new Error('服务器返回了无法读取的上下文设置结果。')}if(response.status===403){contextLocal=false;throw new Error('上下文设置仅可从本机管理。')}if(!body.ok&&!(body.persistent&&body.persistent.committed))throw new Error('上下文设置失败，请检查数值后重试。');const p=body.persistent||{};contextNotice(p.committed&&p.durable?'已保存：下次启动生效，需要重启；当前运行值未改变。':p.committed?'已提交，但尚未确认已持久化；下次启动生效，需要重启；当前运行值未改变。':'未能提交下次启动设置。',!p.committed||!p.durable)}catch(e){contextNotice(e.message,true)}finally{contextBusy=false;contextControls()}}"
"function setMode(value){const mode=['management','monitor'].includes(value)?value:'management';dash.dataset.mode=mode;for(const name of ['management','monitor']){const root=$(name+'Layout'),active=name===mode;root.hidden=!active;root.setAttribute('aria-hidden',String(!active))}try{localStorage.setItem('ds4-dashboard-mode',mode)}catch(e){}document.querySelectorAll('[data-mode-choice]').forEach(b=>b.setAttribute('aria-pressed',String(b.dataset.modeChoice===mode)))}try{setMode(localStorage.getItem('ds4-dashboard-mode'))}catch(e){setMode('management')}document.querySelectorAll('[data-mode-choice]').forEach(b=>b.addEventListener('click',()=>setMode(b.dataset.modeChoice)));const touchKvTarget=()=>{kvTargetTouched=true};$('kvBudgetInput').addEventListener('input',touchKvTarget);$('kvBudgetUnit').addEventListener('input',touchKvTarget);$('kvBudgetUnit').addEventListener('change',touchKvTarget);$('contextNextInput').addEventListener('input',()=>{contextTargetTouched=true});['callFilterCaller','callFilterClient','callFilterApi','callFilterStatus'].forEach(id=>$(id).addEventListener('input',()=>paintCalls((lastSnapshot||{}).calls,(lastSnapshot||{}).request)));"
"async function tick(){const generation=++pollGeneration;try{const response=await fetch('/ds4/status',{cache:'no-store'});if(!response.ok)throw new Error('status '+response.status);const snapshot=await response.json();if(generation===pollGeneration)paint(snapshot)}catch(e){if(generation===pollGeneration){online=false;dash.classList.add('stale');text('health',lastSnapshot?'数据已过期':'不可用');setKvState(kvState);contextControls()}}finally{if(generation===pollGeneration)setTimeout(tick,1000)}}$('kvApplyNow').addEventListener('click',checkKvImpact);$('kvSaveRestart').addEventListener('click',persistKvBudget);$('kvConfirmApply').addEventListener('click',confirmKvApply);$('kvCancelApply').addEventListener('click',cancelKvApply);$('contextSaveRestart').addEventListener('click',saveContext);tick();"
"</script></body></html>\n";
...
static bool header_value(const char *h, size_t n, const char *name,
    ...
    while (p < end) {
        ...
        if (len > namelen && !strncasecmp(line, name, namelen) &&
            line[namelen] == ':') {
            ...
            if (!outlen || vlen >= outlen) return false;
            memcpy(out, v, vlen);
            out[vlen] = '\0';
            return true;
        }
...
static bool kv_admin_fail(kv_admin_error *err, const char *code,
                          const char *message) {
    if (err) {
        err->code = code;
        err->message = message;
...
static bool kv_admin_parse_uint(const char **p, uint64_t *out) {
...
static bool kv_admin_parse_cstr(const char *json, kv_admin_request *out,
    ...
    if (*p == '}') p++;
        ...
        char *key = NULL;
        if (!json_string(&p, &key)) return kv_admin_fail(err, "invalid_json", "malformed JSON object");
        json_ws(&p);
        if (*p++ != ':') { free(key); return kv_admin_fail(err, "invalid_json", "expected ':' after field name"); }
        json_ws(&p);
        if (!strcmp(key, "budget_mb")) {
            if (have_budget) { free(key); return kv_admin_fail(err, "duplicate_field", "duplicate field: budget_mb"); }
            have_budget = true;
            if (!kv_admin_parse_uint(&p, &req.budget_mb)) { free(key); return kv_admin_fail(err, "invalid_budget_mb", "budget_mb must be a non-negative integer"); }
        } else if (!strcmp(key, "mode")) {
            if (have_mode) { free(key); return kv_admin_fail(err, "duplicate_field", "duplicate field: mode"); }
            have_mode = true;
            char *mode = NULL;
            if (!json_string(&p, &mode)) { free(key); return kv_admin_fail(err, "invalid_mode", "mode must be a string"); }
            if (!strcmp(mode, "dry-run")) req.mode = KV_ADMIN_DRY_RUN;
            else if (!strcmp(mode, "apply")) req.mode = KV_ADMIN_APPLY;
        ...
        json_ws(&p);
        if (*p == '}') { p++; break; }
        if (*p++ != ',') return kv_admin_fail(err, "invalid_json", "expected ',' or '}'");
        json_ws(&p);
    }
    json_ws(&p);
...
static bool kv_admin_parse_request(const char *body, size_t body_len,
                                   kv_admin_request *out, kv_admin_error *err) {
    if (!body || memchr(body, '\0', body_len))
        return kv_admin_fail(err, "invalid_json", "request body contains an embedded NUL byte");
    char *json = xmalloc(body_len + 1);
    memcpy(json, body, body_len);
    json[body_len] = '\0';
    bool ok = kv_admin_parse_cstr(json, out, err);
    free(json);
    return ok;
}
...
static bool kv_admin_sockaddr_is_loopback(const struct sockaddr *sa,
    ...
    if (sa->sa_family == AF_INET && salen >= sizeof(struct sockaddr_in)) {
        ...
        return ntohl(v4->sin_addr.s_addr) == 0x7f000001u;
    }
...
static bool kv_admin_peer_is_loopback(int fd) {
...
static kv_admin_persist_result kv_admin_persist_budget_ex(
    ...
    *slash = '\0';
    ...
    int chmod_ok;
#ifdef DS4_SERVER_TEST
    if (kv_admin_test_fail_chmod) { errno = EPERM; chmod_ok = -1; }
    else chmod_ok = chmod(parent, 0700);
#else
    chmod_ok = chmod(parent, 0700);
#endif
    if (chmod_ok != 0) {
    ...
    int n = snprintf(temp, sizeof(temp), "%s/.kv-space-mb.tmp.%ld.%02x%02x%02x%02x",
...
static bool kv_admin_response_ex(int fd, bool cors, int status,
    ...
    buf_puts(&b, ",\"mode\":"); json_escape(&b, req ? kv_admin_mode_name(req->mode) : "");
...
static bool kv_admin_handle_authorized(server *s, int fd, bool cors,
    ...
    if (!content_type || strcasecmp(content_type, "application/json"))
        return kv_admin_response(fd, cors, 400, NULL, NULL, false, false, false,
                                 "invalid_content_type", "Content-Type must be application/json");
    if (!kv_admin_parse_request(body, body_len, &req, &err))
        return kv_admin_response(fd, cors, 400, NULL, NULL, false, false, false,
...
static void test_dashboard_page_is_served_as_html(void) {
    ...
    TEST_ASSERT(socketpair(AF_UNIX, SOCK_STREAM, 0, sv) == 0);
    if (sv[0] < 0 || sv[1] < 0) return;
	int send_buffer = (int)sizeof(dashboard_html) * 2;
	TEST_ASSERT(setsockopt(sv[0], SOL_SOCKET, SO_SNDBUF,
    ...
    TEST_ASSERT(strstr(out, "id=\"managementTitle\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"managementPhase\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"managementRecentCalls\"") != NULL);
    ...
    TEST_ASSERT(strstr(out, "id=\"kvReview\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"kvReviewFacts\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"kvConfirmApply\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"kvCancelApply\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"adminNotice\"") != NULL);
    TEST_ASSERT(strstr(out, "data-mode=\"management\"") != NULL);
    ...
    TEST_ASSERT(strstr(out, "id=\"managementHostPhysical\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"monitorMetrics\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"monitorCalls\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"requestInspector\"") != NULL);
    TEST_ASSERT(strstr(out, "id=\"monitorHostPhysical\"") != NULL);
    ...
    TEST_ASSERT(strstr(out, "textContent") != NULL);
    TEST_ASSERT(strstr(out, "admin('dry-run',mb)") != NULL);
    TEST_ASSERT(strstr(out, "admin('apply',reviewed.mb,String(reviewed.runtime.revision))") != NULL);
    TEST_ASSERT(strstr(out, "admin('apply',reviewed.mb,String(refreshed.revision))") != NULL);
    TEST_ASSERT(strstr(out, "admin('persist',mb)") != NULL);
    TEST_ASSERT(strstr(out, "'X-DS4-Admin':'1'") != NULL);
    TEST_ASSERT(strstr(out, "body.ok") != NULL);
    TEST_ASSERT(strstr(out, "lastSnapshot") != NULL);
    TEST_ASSERT(strstr(out, "body.persistent&&body.persistent.committed") != NULL);
    TEST_ASSERT(strstr(out, "before_entries-r.after_entries") != NULL);
	TEST_ASSERT(strstr(out, "normalizeRuntime") != NULL);
	TEST_ASSERT(strstr(out, "Number.isSafeInteger") != NULL);
	TEST_ASSERT(strstr(out, "$('kvConfirmApply').disabled") != NULL);
	TEST_ASSERT(strstr(out, "setKvState") != NULL);
	TEST_ASSERT(strstr(out, "reviewFingerprint") != NULL);
	TEST_ASSERT(strstr(out, "confirm(") == NULL);
	TEST_ASSERT(strstr(out, "setTimeout(tick,1000)") != NULL);
	TEST_ASSERT(strstr(out, "setInterval(tick") == NULL);
	TEST_ASSERT(strstr(out, "payload.revision=String(revision)") != NULL);
	TEST_ASSERT(strstr(out, "kv_state_changed") != NULL);
...
static void test_kv_admin_parser_is_strict(void) {
	kv_admin_request req = {0};
	kv_admin_error err = {0};
	const char valid[] = "{\"budget_mb\":8192,\"mode\":\"dry-run\"}";
	TEST_ASSERT(kv_admin_parse_request(valid, sizeof(valid) - 1,
	                                   &req, &err));
	...
	const char *bad[] = {
		...
		"{\"budget_mb\":1e3,\"mode\":\"apply\"}",
		"{\"budget_mb\":\"8192\",\"mode\":\"apply\"}",
		"{\"budget_mb\":17592186044416,\"mode\":\"apply\"}",
		"{\"budget_mb\":8192,\"mode\":\"nope\"}",
		"{\"budget_mb\":8192,\"mode\":\"persist\"} trailing",
		"{\"budget_mb\":8192,\"mode\":\"apply\"",
	};
	for (size_t i = 0; i < sizeof(bad) / sizeof(bad[0]); i++) {
		memset(&req, 0, sizeof(req));
		memset(&err, 0, sizeof(err));
		TEST_ASSERT(!kv_admin_parse_request(bad[i], strlen(bad[i]), &req, &err));
		TEST_ASSERT(err.code != NULL && err.message != NULL);
	}
	const char embedded[] = "{\"budget_mb\":8192,\0\"mode\":\"apply\"}";
...
static void test_kv_admin_loopback_sockaddrs(void) {
	...
	TEST_ASSERT(kv_admin_sockaddr_is_loopback((struct sockaddr *)&v4, sizeof(v4)));
	inet_pton(AF_INET, "127.0.0.2", &v4.sin_addr);
	TEST_ASSERT(!kv_admin_sockaddr_is_loopback((struct sockaddr *)&v4, sizeof(v4)));
	inet_pton(AF_INET, "192.168.1.4", &v4.sin_addr);
	TEST_ASSERT(!kv_admin_sockaddr_is_loopback((struct sockaddr *)&v4, sizeof(v4)));
	struct sockaddr_in6 v6 = {0};
	v6.sin6_family = AF_INET6;
	inet_pton(AF_INET6, "::1", &v6.sin6_addr);
	TEST_ASSERT(kv_admin_sockaddr_is_loopback((struct sockaddr *)&v6, sizeof(v6)));
	inet_pton(AF_INET6, "fe80::1", &v6.sin6_addr);
	TEST_ASSERT(!kv_admin_sockaddr_is_loopback((struct sockaddr *)&v6, sizeof(v6)));
	struct sockaddr_un un = {0};
	un.sun_family = AF_UNIX;
	TEST_ASSERT(!kv_admin_sockaddr_is_loopback((struct sockaddr *)&un, sizeof(un)));
}

static void test_kv_admin_persistence_is_atomic_and_private(void) {
	char tmpl[] = "/tmp/ds4-kv-admin-persist.XXXXXX";
	char *root = mkdtemp(tmpl);
	TEST_ASSERT(root != NULL);
	if (!root) return;
	char path[PATH_MAX];
	snprintf(path, sizeof(path), "%s/nested/kv-space-mb", root);
	char detail[160] = {0};
	TEST_ASSERT(kv_admin_persist_budget(path, 8192, detail, sizeof(detail)));
	FILE *fp = fopen(path, "rb");
	TEST_ASSERT(fp != NULL);
	char textbuf[32] = {0};
	TEST_ASSERT(fp && fgets(textbuf, sizeof(textbuf), fp) != NULL);
	if (fp) fclose(fp);
	TEST_ASSERT(!strcmp(textbuf, "8192\n"));
	struct stat st;
	TEST_ASSERT(stat(path, &st) == 0 && (st.st_mode & 0777) == 0600);
	char parent[PATH_MAX];
	snprintf(parent, sizeof(parent), "%s/nested", root);
	TEST_ASSERT(stat(parent, &st) == 0 && (st.st_mode & 0777) == 0700);
	char rename_fail[PATH_MAX];
	snprintf(rename_fail, sizeof(rename_fail), "%s/nested/existing-dir", root);
	TEST_ASSERT(mkdir(rename_fail, 0700) == 0);
	TEST_ASSERT(!kv_admin_persist_budget(rename_fail, 4096, detail, sizeof(detail)));
	DIR *nested = opendir(parent);
	TEST_ASSERT(nested != NULL);
	if (nested) {
		struct dirent *de;
		while ((de = readdir(nested)) != NULL)
			TEST_ASSERT(strstr(de->d_name, ".tmp.") == NULL);
		closedir(nested);
	}
	kv_admin_test_fail_chmod = true;
	...
	snprintf(impossible, sizeof(impossible), "%s/file/kv-space-mb", root);
	FILE *block = fopen(impossible, "wb");
	TEST_ASSERT(block == NULL);
	char blocker[PATH_MAX];
	snprintf(blocker, sizeof(blocker), "%s/file", root);
	block = fopen(blocker, "wb");
	TEST_ASSERT(block != NULL);
	if (block) fclose(block);
	TEST_ASSERT(!kv_admin_persist_budget(impossible, 4096, detail, sizeof(detail)));
	TEST_ASSERT(detail[0] != '\0');
...
static char *test_kv_admin_route(server *s, const char *request_text,
	                             bool loopback_tcp) {
	int client_fd = -1, server_fd = -1, listener = -1;
	if (loopback_tcp) {
	...
	TEST_ASSERT(send_all(client_fd, request_text, strlen(request_text)));
...
static void test_kv_admin_actual_route_and_peer_auth(void) {
	...
	server_status_init(&s);
	server_kv_init(&s);
	char tmpl[] = "/tmp/ds4-kv-admin-route.XXXXXX";
	char *dir = mkdtemp(tmpl);
	TEST_ASSERT(dir != NULL);
	s.kv.enabled = true;
	s.kv.dir = xstrdup(dir);
	...
	snprintf(forbidden_path, sizeof(forbidden_path), "%s/.ds4/kv-space-mb", dir);
	TEST_ASSERT(access(forbidden_path, F_OK) != 0);
	free(out);
	if (old_home) { TEST_ASSERT(setenv("HOME", old_home, 1) == 0); free(old_home); }
	else TEST_ASSERT(unsetenv("HOME") == 0);

	snprintf(request_text, sizeof(request_text),
		"GET /ds4/admin/kv-cache HTTP/1.1\r\nContent-Length: %zu\r\n\r\n%s",
		strlen(body), body);
	out = test_kv_admin_route(&s, request_text, true);
...
static void test_kv_admin_handler_semantics(void) {
	...
	server_kv_init(&s);
	char *out = test_kv_admin_core(&s,
		"{\"budget_mb\":8192,\"mode\":\"dry-run\"}", NULL);
	TEST_ASSERT(strstr(out, "HTTP/1.1 409") != NULL);
	TEST_ASSERT(strstr(out, "\"mode\":\"dry-run\"") != NULL);
	TEST_ASSERT(strstr(out, "\"runtime\":{\"attempted\":true,\"ok\":false") != NULL);
	TEST_ASSERT(strstr(out, "\"persistent\":{\"attempted\":false,\"ok\":false") != NULL);
	free(out);
	out = test_kv_admin_core(&s,
	...
	TEST_ASSERT(strstr(out, "HTTP/1.1 400") != NULL);
	TEST_ASSERT(strstr(out, "\"code\":\"invalid_json\"") != NULL);
	free(out);

	char tmpl[] = "/tmp/ds4-kv-admin-handler.XXXXXX";
	char *dir = mkdtemp(tmpl);
	TEST_ASSERT(dir != NULL);
	if (dir) {
		s.kv.enabled = true;
	...
	out = test_kv_admin_core(&s,
		"{\"budget_mb\":8192,\"mode\":\"persist\"}", "/dev/null/kv-space-mb");
	TEST_ASSERT(strstr(out, "HTTP/1.1 500") != NULL);
	TEST_ASSERT(strstr(out, "\"runtime\":{\"attempted\":false,\"ok\":false") != NULL);
	TEST_ASSERT(strstr(out, "\"persistent\":{\"attempted\":true,\"ok\":false") != NULL);
	free(out);
	char persist_tmpl[] = "/tmp/ds4-kv-admin-core-persist.XXXXXX";
	char *persist_dir = mkdtemp(persist_tmpl);
	TEST_ASSERT(persist_dir != NULL);
	if (persist_dir) {
		char persist_path[PATH_MAX];
		snprintf(persist_path, sizeof(persist_path), "%s/kv-space-mb", persist_dir);
		kv_admin_test_fail_chmod = true;
		out = test_kv_admin_core(&s,
			"{\"budget_mb\":8192,\"mode\":\"persist\"}", persist_path);
		kv_admin_test_fail_chmod = false;
		TEST_ASSERT(strstr(out, "HTTP/1.1 500") != NULL);
		TEST_ASSERT(strstr(out, "\"persistent\":{\"attempted\":true,\"ok\":false") != NULL);
