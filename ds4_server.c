...
".page{max-width:1240px;margin:auto;padding:32px 32px 64px}.masthead{display:grid;grid-template-columns:1fr auto;gap:24px;padding-bottom:18px;border-bottom:2px solid var(--ink)}h1,h2,p{margin:0}.brand{font:700 28px/1 Georgia,\"Times New Roman\",serif}.model{margin-top:9px;color:var(--muted)}.state{display:flex;gap:18px;align-items:flex-end}.eyebrow{color:var(--muted);font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase}.state strong{display:block;margin-top:4px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-weight:500}.phase{color:var(--accent)}"
".hero{display:grid;grid-template-columns:2fr 1fr;border-bottom:1px solid var(--line)}.hero>div{padding:42px 0 36px}.hero>div+div{border-left:1px solid var(--line);padding-left:36px}.hero-value{font:400 clamp(62px,9vw,126px)/.88 Georgia,\"Times New Roman\",serif;letter-spacing:-.055em;margin:18px 0 16px}.secondary-value{font:400 clamp(42px,5vw,72px)/1 Georgia,\"Times New Roman\",serif;margin:22px 0 18px}.accent{color:var(--accent)}.caption{color:var(--muted)}.mono{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-variant-numeric:tabular-nums}"
".strip{display:grid;grid-template-columns:repeat(4,1fr);border-bottom:1px solid var(--ink)}.datum{min-width:0;padding:20px 20px 22px 0}.datum+.datum{border-left:1px solid var(--line);padding-left:20px}.datum strong{display:block;margin-top:8px;font:400 20px/1.25 Georgia,\"Times New Roman\",serif}.datum small{display:block;color:var(--muted);margin-top:6px}.progress{height:3px;background:var(--line);margin-top:13px;overflow:hidden}.progress span{display:block;height:100%;width:0;background:var(--accent);transition:width .2s linear}"
".section{padding:30px 0;border-bottom:1px solid var(--ink)}.section-head{display:flex;justify-content:space-between;align-items:baseline;gap:20px;margin-bottom:20px}.section h2{font:400 27px/1.1 Georgia,\"Times New Roman\",serif}.process{display:grid;grid-template-columns:1fr 1fr 1fr;gap:28px}.big{font:400 44px/1 Georgia,\"Times New Roman\",serif;margin:10px 0}.capacity-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:44px}.capacity-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.capacity-stats strong{display:block;margin-top:7px;font-size:19px}.editor{border-left:1px solid var(--line);padding-left:34px}.controls{display:flex;flex-wrap:wrap;gap:9px;margin-top:14px}.notice{min-height:24px;margin-top:14px;color:var(--muted)}.notice.bad{color:var(--bad)}"
...
".theme-layout[hidden]{display:none!important}.admin-dock{margin:30px 0;padding:22px;border:1px solid var(--ink);display:grid;grid-template-columns:1fr 1fr;gap:28px}.admin-dock .editor{border-left:0;padding-left:0}.terminal-layout{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace}.terminal-line{padding:13px 0;border-bottom:1px solid var(--line);display:flex;gap:12px;justify-content:space-between}.terminal-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:var(--line);border:1px solid var(--line)}.terminal-grid>div{background:var(--paper);padding:18px;min-width:0}.terminal-grid strong{display:block;font-size:22px;margin-top:9px;overflow-wrap:anywhere}.terminal-events{list-style:none;padding:0;margin:0;border-top:1px solid var(--line)}.terminal-events li{display:grid;grid-template-columns:7rem 1fr auto;gap:12px;padding:11px 0;border-bottom:1px solid var(--line);overflow-wrap:anywhere}.calm-layout{max-width:900px;margin:0 auto}.calm-hero{text-align:center;padding:56px 18px;border-bottom:1px solid var(--line)}.calm-hero strong{display:block;font:400 clamp(48px,8vw,88px)/1 Georgia,serif;color:var(--accent);margin:14px 0}.calm-notes{display:grid;grid-template-columns:1fr 1fr;gap:38px;margin:38px 0}.calm-note{padding:24px;border-top:3px solid var(--accent);background:rgba(255,255,255,.25)}.calm-note strong{display:block;font:400 34px/1.1 Georgia,serif;margin:12px 0}.calm-timeline{list-style:none;margin:0;padding:0}.calm-timeline li{position:relative;padding:0 0 22px 28px;border-left:1px solid var(--line);overflow-wrap:anywhere}.calm-timeline li:before{content:'';position:absolute;width:9px;height:9px;border-radius:50%;left:-5px;top:5px;background:var(--accent)}@media(max-width:760px){.admin-dock,.terminal-grid,.calm-notes{grid-template-columns:1fr}.terminal-events li{grid-template-columns:1fr;gap:4px}.admin-dock{gap:22px}.calm-hero{padding:38px 8px}}"
".paper-conclusion{display:grid;grid-template-columns:1.4fr 1fr 1fr;gap:0;margin-top:28px;border-top:2px solid var(--ink);border-bottom:1px solid var(--ink)}.paper-conclusion>div{padding:22px 20px 22px 0}.paper-conclusion>div+div{padding-left:20px;border-left:1px solid var(--line)}.paper-conclusion strong{display:block;margin-top:8px;font:400 30px/1.1 Georgia,serif;overflow-wrap:anywhere}.paper-conclusion .conclusion-health{color:var(--accent)}@media(max-width:760px){.paper-conclusion{grid-template-columns:1fr;margin-top:20px}.paper-conclusion>div+div{padding-left:0;border-left:0;border-top:1px solid var(--line)}}"
"</style></head><body><main class=\"page\" id=\"dashboard\" data-theme=\"paper\"><header class=\"masthead\"><div><h1 class=\"brand\">DS4 / 运行报告</h1><p id=\"model\" class=\"model\">正在读取状态</p></div><div class=\"theme-switch\" role=\"group\" aria-label=\"显示主题\"><button type=\"button\" data-theme-choice=\"paper\" aria-pressed=\"true\">纸面运行报告</button><button type=\"button\" data-theme-choice=\"terminal\" aria-pressed=\"false\">深色控制台</button><button type=\"button\" data-theme-choice=\"calm\" aria-pressed=\"false\">从容解释型</button></div><div class=\"state\"><div><span class=\"eyebrow\">阶段</span><strong id=\"phase\" class=\"phase\">连接中</strong></div><div><span class=\"eyebrow\">健康</span><strong id=\"health\">等待中</strong></div><div><span class=\"eyebrow\">队列</span><strong id=\"queue\">0</strong></div><div><span class=\"eyebrow\">客户端</span><strong id=\"clients\">0</strong></div></div></header><div id=\"paperLayout\" class=\"theme-layout paper-layout\" aria-hidden=\"false\"><section id=\"paperConclusion\" class=\"paper-conclusion\" aria-label=\"运行结论\"><div class=\"conclusion-health\"><span class=\"eyebrow\">当前运行结论</span><strong id=\"paperHealthConclusion\" data-bind=\"health\">等待中</strong><p data-bind=\"phase\" class=\"caption\">连接中</p></div><div><span class=\"eyebrow\">上下文摘要</span><strong id=\"paperContextSummary\" data-bind=\"contextCurrent\">—</strong><p data-bind=\"contextRemaining\" class=\"caption\">—</p></div><div><span class=\"eyebrow\">KV 缓存摘要</span><strong id=\"paperCacheSummary\" data-bind=\"requestHitRate\">—</strong><p data-bind=\"kvUtilization\" class=\"caption\">—</p></div></section>"
...
"<section class=\"section\" id=\"callsSection\"><div class=\"section-head\"><h2>调用记录</h2><p id=\"callsActive\" class=\"caption\">当前活动请求：—</p></div><div class=\"call-filters\"><input id=\"callFilterCaller\" data-call-filter=\"caller\" aria-label=\"按调用方筛选\" placeholder=\"调用方\"><select id=\"callFilterClient\" data-call-filter=\"client\" aria-label=\"按服务筛选\"><option value=\"\">全部服务</option></select><select id=\"callFilterApi\" data-call-filter=\"api\" aria-label=\"按 API 筛选\"><option value=\"\">全部 API</option></select><select id=\"callFilterStatus\" data-call-filter=\"result\" aria-label=\"按结果筛选\"><option value=\"\">全部结果</option><option value=\"active\">进行中</option><option value=\"completed\">完成</option><option value=\"failed\">失败</option></select></div><div class=\"call-table-wrap\"><table><thead><tr><th>请求</th><th>服务</th><th>调用方</th><th>API</th><th>结果</th><th>错误</th></tr></thead><tbody id=\"callsRecords\"></tbody></table></div><h3>服务 / 调用方汇总</h3><div class=\"call-table-wrap\"><table><thead><tr><th>服务</th><th>调用方</th><th>调用</th><th>失败</th><th>提示 token</th></tr></thead><tbody id=\"callsCallers\"></tbody></table></div></section>"
"<section class=\"section\"><div class=\"section-head\"><h2>Request detail</h2></div><table><tbody id=\"requestDetail\"></tbody></table></section></div>"
"<section id=\"terminalLayout\" class=\"theme-layout terminal-layout\" hidden aria-hidden=\"true\" aria-label=\"深色控制台\"><div class=\"terminal-line\"><span>DS4 LIVE / <span data-bind=\"phase\">连接中</span></span><span><span data-bind=\"model\">—</span></span></div><section class=\"section\"><div class=\"section-head\"><h2>即时读数</h2><p class=\"caption\">紧凑排障视图</p></div><div class=\"terminal-grid\"><div><span class=\"eyebrow\">KV 请求命中</span><strong data-bind=\"requestHitRate\">—</strong></div><div><span class=\"eyebrow\">解码</span><strong data-bind=\"decodeSpeed\">—</strong></div><div><span class=\"eyebrow\">上下文</span><strong data-bind=\"contextCurrent\">—</strong></div><div><span class=\"eyebrow\">内存压力</span><strong data-bind=\"hostPressure\">—</strong></div></div></section><section class=\"section\"><div class=\"section-head\"><h2>调用事件流</h2><p data-bind=\"callsActive\" class=\"caption\">当前活动请求：—</p></div><ol id=\"terminalCallStream\" class=\"terminal-events\"></ol></section></section>"
"<section id=\"calmLayout\" class=\"theme-layout calm-layout\" hidden aria-hidden=\"true\" aria-label=\"从容解释型\"><section class=\"calm-hero\"><span class=\"eyebrow\">此刻的运行状态</span><strong data-bind=\"health\">等待中</strong><p data-bind=\"model\" class=\"caption\">正在读取状态</p></section><section class=\"calm-notes\"><article class=\"calm-note\"><span class=\"eyebrow\">上下文余量</span><strong data-bind=\"contextRemaining\">—</strong><p>当前窗口的可用 token；调整上限将在下次启动生效。</p></article><article class=\"calm-note\"><span class=\"eyebrow\">主机资源</span><strong data-bind=\"hostPhysical\">不可用</strong><p data-bind=\"hostPressure\">不可用</p></article></section><section class=\"section\"><div class=\"section-head\"><h2>最近调用时间线</h2><p>每一条记录都保留 API 和执行结果。</p></div><ol id=\"calmCallTimeline\" class=\"calm-timeline\"></ol></section></section>"
"<aside id=\"adminDock\" class=\"admin-dock\" aria-label=\"本机管理操作\"></aside></main><script>"
...
"function chineseStatic(){$('currentTitle').textContent='当前请求 / KV token 命中';document.querySelectorAll('#paperLayout .hero .eyebrow').forEach((e,i)=>e.textContent=['当前请求 / KV token 命中','解码 / 平均'][i]);document.querySelectorAll('#paperLayout .hero .caption').forEach(e=>e.textContent='—');document.querySelectorAll('#paperLayout .strip .eyebrow').forEach((e,i)=>e.textContent=['预填充','解码进度','当前会话','请求'][i]);document.querySelectorAll('#paperLayout .process .eyebrow').forEach((e,i)=>e.textContent=['token 命中率','请求命中率','结果'][i]);document.querySelectorAll('#kvCapacity .capacity-stats .eyebrow').forEach((e,i)=>e.textContent=['已用','容量上限','条目 / 利用率'][i]);document.querySelectorAll('#paperLayout .section h2').forEach((e,i)=>e.textContent=['进程记录','磁盘 KV 容量','上下文窗口','主机资源','调用记录','请求详情'][i]);document.querySelectorAll('#paperLayout .section-head .caption').forEach((e,i)=>{if(i<4)e.textContent=['计数器会在此服务器进程重启时清零。','索引磁盘缓存；上方实时上下文以 token 计。','数值以 token 计，不代表 RAM。','系统采样不可用时明确标注。'][i]});$('kvForm').querySelector('label').textContent='容量上限';$('kvBudgetUnit').setAttribute('aria-label','容量单位');$('budgetHelp').textContent='最小 256 MB。立即应用会修改运行时状态；保存会写入下次启动上限。';$('kvApplyNow').textContent='立即应用';$('kvSaveRestart').textContent='保存供重启后使用';$('adminDock').append($('kvForm'),$('contextForm'))}chineseStatic();"
...
"function renderThemeCalls(items){for(const id of ['terminalCallStream','calmCallTimeline']){const list=$(id);list.replaceChildren();for(const item of items){const li=document.createElement('li'),request=document.createElement('span'),detail=document.createElement('span'),status=document.createElement('span');request.textContent='#'+(item.request_id||'—');detail.textContent=(item.client||'未标识服务')+' · '+(item.caller||'未知调用方')+' · '+(item.api||'未知 API')+(item.error?' · '+item.error:'');status.textContent=item.status;li.append(request,detail,status);list.append(li)}}}"
...
"function contextNotice(message,bad){$('contextNotice').className=bad?'notice bad':'notice';text('contextNotice',message)}async function saveContext(){if(contextBusy)return;const value=Number($('contextNextInput').value);if(!Number.isInteger(value)||value<4096||value>2147483647){contextNotice('请输入 4,096 到 2,147,483,647 之间的整数 token 上限。',true);return}contextBusy=true;contextNotice('正在保存下次启动设置…',false);contextControls();try{const response=await fetch('/ds4/admin/context',{method:'POST',headers:{'Content-Type':'application/json','X-DS4-Admin':'1'},body:JSON.stringify({context_tokens:value})});let body;try{body=await response.json()}catch(e){throw new Error('服务器返回了无法读取的上下文设置结果。')}if(response.status===403){contextLocal=false;throw new Error('上下文设置仅可从本机管理。')}if(!body.ok&&!(body.persistent&&body.persistent.committed))throw new Error('上下文设置失败，请检查数值后重试。');const p=body.persistent||{};contextNotice(p.committed&&p.durable?'已保存：下次启动生效，需要重启。':p.committed?'已提交，但尚未确认已持久化；下次启动生效，需要重启。':'未能提交下次启动设置。',!p.committed||!p.durable)}catch(e){contextNotice(e.message,true)}finally{contextBusy=false;contextControls()}}"
"function setTheme(value){const theme=['paper','terminal','calm'].includes(value)?value:'paper';dash.dataset.theme=theme;for(const name of ['paper','terminal','calm']){const root=$(name+'Layout'),active=name===theme;root.hidden=!active;root.setAttribute('aria-hidden',String(!active))}try{localStorage.setItem('ds4-dashboard-theme',theme)}catch(e){}document.querySelectorAll('[data-theme-choice]').forEach(b=>b.setAttribute('aria-pressed',String(b.dataset.themeChoice===theme)))}try{setTheme(localStorage.getItem('ds4-dashboard-theme'))}catch(e){setTheme('paper')}document.querySelectorAll('[data-theme-choice]').forEach(b=>b.addEventListener('click',()=>setTheme(b.dataset.themeChoice)));['callFilterCaller','callFilterClient','callFilterApi','callFilterStatus'].forEach(id=>$(id).addEventListener('input',()=>paintCalls((lastSnapshot||{}).calls)));"
