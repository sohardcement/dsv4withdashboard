...
base_calls = {"active_request_id":"99","records":[{"request_id":"99","caller":"direct","client":"hanako-agent","api":"responses","status":"active","error":"<img src=x>"},{"request_id":"98","caller":"192.0.2.7","client":"hermes-agent","api":"chat","status":"failed","error":"<script>坏</script>"},{"request_id":"97","caller":"192.0.2.9","client":"openclaw","api":"chat","status":"completed","error":""},{"request_id":"96","caller":"<b>恶意调用方</b>","client":"<img src=x onerror=alert(1)>","api":"chat","status":"failed","error":"<script>坏</script>"}],"callers":[{"caller":"direct","client":"hanako-agent","calls":4,"failed":0,"prompt_tokens":90},{"caller":"192.0.2.7","client":"hermes-agent","calls":2,"failed":1,"prompt_tokens":40},{"caller":"192.0.2.9","client":"openclaw","calls":3,"failed":0,"prompt_tokens":22},{"caller":"<b>恶意调用方</b>","client":"<img src=x onerror=alert(1)>","calls":1,"failed":1,"prompt_tokens":8}]}
