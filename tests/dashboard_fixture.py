...
base_calls = {"active_request_id":"99","records":[
    ...
    {"request_id":"98","caller":"192.0.2.7","client":"hermes-agent","api":"chat","status":"failed","kind":"chat","stream":False,"tools":False,"started_at":2000.0,"finished_at":2042.1,"prompt_tokens":39712,"cached_tokens":24576,"cache_write_tokens":4096,"output_tokens":128,"cache_source":"memory","finish":"error","error":"<script>坏</script>"},
    {"request_id":"97","caller":"192.0.2.9","client":"openclaw","api":"chat","status":"completed","kind":"completion","stream":True,"tools":False,"started_at":3000.0,"finished_at":3012.5,"prompt_tokens":8192,"cached_tokens":4096,"cache_write_tokens":1024,"output_tokens":512,"cache_source":"disk-text","finish":"stop","error":""},
    {"request_id":"96","caller":"<b>恶意调用方</b>","client":"<img src=x onerror=alert(1)>","api":"chat","status":"failed","kind":"chat","stream":False,"tools":False,"started_at":4000.0,"finished_at":4001.0,"prompt_tokens":8,"cached_tokens":0,"cache_write_tokens":0,"output_tokens":0,"cache_source":"","finish":"error","error":"<script>坏</script>"},
    {"request_id":"95","caller":"198.51.100.12","client":"batch-evaluator","api":"completions","status":"completed","kind":"completion","stream":False,"tools":False,"started_at":5000.0,"finished_at":5008.4,"prompt_tokens":16384,"cached_tokens":12288,"cache_write_tokens":2048,"output_tokens":256,"cache_source":"memory","finish":"stop","error":""}],
