async page => {
  ...
  assert(await page.locator('#managementRecentCalls [data-call-id]').count()===3&&(await page.locator('#managementRecentCalls').innerText()).includes('hanako-agent'),'management recent calls are incomplete');
